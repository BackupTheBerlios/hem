 ...
 * @version $Id: PEAR_Auth.php,v 1.1 2004/06/08 11:42:53 mloitzl Exp $
 * @package LiveUser
 * @category authentication
 */
class LiveUser_Auth_Container_PEAR_Auth extends LiveUser_Auth_Common
{
    ...
    function &LiveUser_Auth_Container_PEAR_Auth(&$connectOptions)
    {
        ...
        if (!is_object($this->pearAuth)) {
            $this->pearAuth = new Auth($connectOptions['pearAuthContainer'], $connectOptions, '', false);
        }
    }
    ...
    {
        $this->LiveUser_Auth_Container_PEAR_Auth($connectOptions);
    }
