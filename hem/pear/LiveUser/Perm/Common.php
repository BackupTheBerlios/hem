 ...
 * @version $Id: Common.php,v 1.1 2004/06/08 11:42:56 mloitzl Exp $
 * @package LiveUser
 * @category authentication
 */
class LiveUser_Perm_Common
{
    ...
    /**
     * Checks if the current user has a certain right in a
     * given area with the sufficient level to gain access
     * to a specific ressource in that area.
     *
     * @param  integer  Id of the right within the AuthArea to check for.
     * @param  integer  Id of the owner of the ressource for
     *                  which the right is requested.
     * @param  mixed    Id or array of Ids of the group of the
     *                  ressource for which the right is requested.
     * @param   integer $area_id  Id of the area in which the right is stored.
     * @return boolean  true if the level is sufficient to grant access else false.
     */
    function checkRightLevel($right_id, $owner_user_id, $owner_group_id, $area_id = null)
    {
        return LiveUser::raiseError(LIVEUSER_ERROR_NOT_SUPPORTED, null, null,
            'Method not supported by this container');
    }
