 ...
 * @version $Id: XML.php,v 1.1 2004/07/16 13:58:45 mloitzl Exp $
 * @package LiveUser
 * @category authentication
 */
class LiveUser_Auth_Container_XML extends LiveUser_Auth_Common
{
    ...
    /**
     * LiveUser_Auth_Container_XML::LiveUser_Auth_Container_XML()
     *
     * Class constructor.
     *
     * @param  mixed
    ...
    /**
     * LiveUser_Auth_Container_XML::updateUserData()
     *
     ...
     * @return boolean
     */
    function readUserData($userHandle, $userPasswd = false)
    {
        if (!$this->init_ok) {
            return false;
        }
